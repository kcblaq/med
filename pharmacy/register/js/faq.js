$(function () {
    ...
    const faqs = [
      {
        question: "Must my Pharmacy be registered?",
        answer:
          "Yes. Your business should be registered with the right authorities.",
      },
      {
        question: "Does Medloc accept all the banks?",
        answer: "Yes, all the CBN approved banks can be used for ...",
      },
      {
        question: "Who pays for the delivery of drugs?",
        answer:
          "The cost of dispatch delivery is on the shoulder of the both patient and the pharmacy at the ratio of 60:40 respectively",
      },
      {
        question: "Can I add other items?",
        answer:
          "The cost of dispatch delivery is on the shoulder of the both patient and the pharmacy at the ratio of 60:40 respectively",
      },
      {
    ...
    function createFaqItem(faq) {
      const faqItem = $('<div class="faq-item">').append(
        $(
          '<div class="question font-bold w-full cursor-pointer truncate flex mb-4 items-center">'
        )
          .text(faq.question)
          .append('<i class="fa fa-caret-down ml-2"></i>'),
